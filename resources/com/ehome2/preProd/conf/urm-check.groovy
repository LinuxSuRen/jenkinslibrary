...
env.Port = "32342"
env.Appid = "user-248"
env.target_dir = "${WORKSPACE}/urm-parent/urm-check"
env.request_mem = "1Gi"
env.limit_mem = "2Gi"
env.java_Xms = "1g"
env.java_Xmx = "1g"
...
env.dockerFile_start="java -Denv=${env.release} -Dapp.id=${env.Appid} -Dapollo.configService=${env.Apollo} ${env.JAVA_OPTS} -Dserver.port=${env.Port} -Djava.security.egd=file:/dev/./urandom -jar /opt/${Service}.jar"
